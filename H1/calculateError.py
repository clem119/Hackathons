...
#creat an array that has the amount of value for each value of MW rounded
...
#compute de error by taking the difference between the curve and the real value (rounded)
